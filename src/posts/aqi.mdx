...
<GatsbyImage alt="image" image={props['hero-app-home']} />

<Grid cols={4} className="mt-50">
    <div className="p-16">
        <h4 className="f-24 mb-16 mt-16">Team</h4>
        <p>Jacqueline Gullion (Senior UX designer at Aquatic Informatics) Jacob Burd(UX designer at Hack)</p>
    </div>
    <div className="p-16">
    ...
    <div className="p-16">
        ...
        <p>Stakeholder interviews, MVP & Target mapping, User Research, Product Design, UX</p>
    </div>
    <div className="p-16">
...
<Grid cols={4} className="mb-16">
    <div  className="p-16">
        <h4 className="f-24 mb-16 mt-16">3 Senior Devs</h4>
...
<div classname="w-100 mt-50 flex flex-center justify-center">
    <div className="flex w-600">
        <div style={{ width: 150, height: 150 }}>
            <GatsbyImage style={{ width: 150, height: 150 }} alt="Picture of persona" image={props["marcel-persona"]} />
        </div>
        <div className="ml-16">
...
<Overflow caption="Considered products for benchmarking">
    <GatsbyImage alt="Considered products for benchmarking" image={props["benchamarking-miro-board"]} />
</Overflow>
...
<Overflow>
    <Grid cols={2}>
        <div className="p-16">
            <GatsbyImage alt="" image={props['home-v1']} />
            <div className="m-auto w-80">
...
<Overflow>
    <Grid cols={2}>
        <div className="p-16">
            <GatsbyImage alt="" image={props['discover-v1']} />
            <div className="m-auto w-80">
        ...
        <div className="p-16">
            ...
            <div className="m-auto w-80">
                <h4 className="f-24 mb-16 mt-16">Solution: visually pleasing content</h4>
...
<Overflow>
    <GatsbyImage alt="" image={props['home-final-safari']} />
</Overflow>
