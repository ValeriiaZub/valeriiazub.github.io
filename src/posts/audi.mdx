...
<div style={{
   ...
   // justifyItems: 'center',
    ...
    <p className="w-500 bold">QR code connects user to the Audi web application.</p>
    ...
    <p className="w-500 bold">Passengers phone establishes connection with driver’s phone.</p>
    ...
    <p className="w-500 bold">Driver’s phone receives and tolerates requests from passengers’ phones.</p>
    <div className="flex flex-center  justify-center "><IndicatorsUpDown /></div>
    <div></div>
    <div className="flex flex-center  justify-center "><Car/></div>
    <p className="w-500 bold">Car dashboard tolerates and adjusts interior setings, such as audio volume and seating angle.</p>
</div>
...
A year later I have learned that the marketing agency that was a sponsor has developed a route tracking app for e-tron, the latest Audi all electric SUV. The nature of the competition was allowing us to think big and design far into the future. **In the real world I would make sure to understand what each stakeholder wants and what are the business goals.** Perhaps, one day, a hackathon solution could be developed and put on a market. I'll never stop trying.
